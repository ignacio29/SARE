...
if (!isset($_SESSION['asistente']) && !isset($_SESSION['usuario'])) {
  ...
  <header>
    ...
    <div class="logo">
      ...
      <ul>
        ...
        <li class="submenu">
          <a href="#"  data-toggle="modal" data-target="#myModal2"    onclick="cargarPerfil('<?php echo $_SESSION['usuario']?>','<?php echo $_SESSION['asistente']?>')"><span class="icon-profile"></span>PERFIL</a>
        </li>
       ...
       <div class="modal-dialog" role="document">
          <div class="modal-content">
             <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel2">ASISTENTE</h4>
             </div>
