...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-04-2018 a las 11:18:32
...
SELECT ar.iddano as iddano,ar.nombrearticulo as nombreArti, ar.seriearticulo as serie,ar.tipoarticulo as tipo,ar.clasearticulo as clase
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `updateEstadoArticuloDeficiente` (IN `id` INT)  NO SQL
UPDATE tbarticulos SET estadoarticulo='Buen Estado' WHERE tbarticulos.idarticulo=id$$
...
(1, '207270826', 'Jose', 'Alfaro', 'Rodriguez', 'M', 5, 2014, 'Ingenieria en sistemas', 3, 1, 0);
...
(1, '12345678', 'Perro', 'Triste', '12345678-1ehNPoT82cZ-op.png', '2018-04-14'),
(2, '12345678', 'caballo', 'Brincando', '12345678-2aq9NZi3XCQ-op.png', '2018-04-14'),
(3, '70244080808', 'SANTA.png', '2.0', '70244080808-1kvxI39pX8S-op.png', '2018-04-14'),
(4, '70244080808', 'saludo Feliz', '20.0', '70244080808-4c8B6y79mx2-op.png', '2018-04-14'),
(5, '70244080808', 'saludo 2.34', 'dad', '70244080808-3Gyj1LpeO9b-op.png', '2018-04-14');
