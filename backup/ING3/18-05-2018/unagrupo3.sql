...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-05-2018 a las 02:21:52
...
LEFT JOIN tblogin l 
	ON l.idlogin = asi.loginid AND asi.cedulaasistente= cedula
WHERE asi.cedulaasistente = cedula$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `mostrarComentariosNotica` (IN `idnoticia` INT(11))  NO SQL
SELECT cm.comentario,e.nombreestudiante n0,e.primerapellidoestudiante p0,e.segundoapellidoestudiante pp0, asi.nombreasistente n1, asi.primerapellidoasistente p1,asi.segundoapellidoasistente pp1, adm.nombreadministrador n2,adm.primerapellidoadministrador p2, adm.segundoapellidoadministrador pp2 
FROM tbcomentarionoticia cm
LEFT JOIN tbasistente asi
    ON asi.cedulaasistente = cm.cedularesponsable 
LEFT JOIN tbadministrador adm
    ON adm.cedulaadministrador = cm.cedularesponsable 
LEFT JOIN tbestudiante e
	ON e.cedulaestudiante =  cm.cedularesponsable 
WHERE cm.idnoticia= idnoticia
ORDER BY cm.idcomentario DESC$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `mostrarTodasNoticias` ()  READS SQL DATA
SELECT n.idnoticia,n.temanoticia,n.descripcionnoticia,n.fotonoticia,n.fechanoticia, asi.nombreasistente n1, asi.primerapellidoasistente p1,asi.segundoapellidoasistente pp1, adm.nombreadministrador n2,adm.primerapellidoadministrador p2, adm.segundoapellidoadministrador pp2 
FROM tbnoticias n
LEFT JOIN tbasistente asi
    ON asi.cedulaasistente = n.idcreadornoticia 
LEFT JOIN tbadministrador adm
    ON adm.cedulaadministrador = n.idcreadornoticia
    ORDER BY n.fechanoticia DESC$$
...
--
-- Volcado de datos para la tabla `tbarticulodanado`
--

INSERT INTO `tbarticulodanado` (`iddano`, `idarticulo`, `cedulacreador`, `descripciondano`, `fecha`) VALUES
(1, 11, '207270826', 'Malisimo', '2018-05-18');
...
('LAPTOP', 5, 3232, '12345678', 'COCINA', 'Black an core i3 ', 'BUENO', 'Institucional', 1),
('Pantalla', 11, 4344, '207270826', 'ELECTRONICO', 'LCD32PLG', 'DEFICIENTE', 'Personal', 0),
('LAPTOP', 14, 2232, '207270826', 'COCINA', 'PC INTEL', 'BUENO', 'Personal', 0);
...
(1, '70244080808', 'Luis Carlos', 'Parra', 'Cambronero', 'M', 2);
...
(28, 37, '12345678', 'fgfgfgfg'),
(29, 37, '12345678', 'Hola'),
(30, 37, '12345678', 'Hola'),
(31, 37, '12345678', 'Hola'),
(32, 39, '12345678', 'Nuevo Comentario'),
(33, 39, '12345678', 'sasaSAs'),
(34, 39, '12345678', 'sasasas'),
(35, 39, '12345678', 'sasasas'),
(36, 39, '12345678', 'Hola mundo '),
(37, 39, '12345678', '4rrfrgrg'),
(38, 43, '12345678', 'hgjghjhgh'),
(39, 37, '12345678', 'sddd'),
(40, 39, '70244080808', 'Luis Parra'),
(41, 39, '70244080808', 'weeewwew'),
(42, 39, '12345678', 'jnkjnkj mnkjbkh');
...
(1, '207270826', 'Jose ', 'Alfaro', '   Rodriguez', 'M', 5, 2014, 'Administracion de empresas', 3, 1, 1),
(2, '115700773', 'Jose', 'Garro', '  Duran', 'M', 3, 2012, 'Administracion de empresas', 5, 0, 1);
...
(1, 1, 'MARTES', '08AM', '12MD', 'PM-Iliana'),
(2, 1, 'LUNES', '01PM', '05PM', 'ETP-Rodolfo'),
(3, 1, 'MIERCOLES', '05PM', '09PM', 'MIV-JG'),
(4, 1, 'JUEVES', '08AM', '12MD', 'ING3-Steven');
...
(5, 'joseduran@gmail.com', 'duran2', 'estudiante');
...
(35, '70244080808', 'Taller Recreativo', 'Nuevo capítulo, nuevo conjunto de propiedades CSS. Vamos a ver los bordes y los efectos de sombreado que se pueden aplicar, tanto en el texto como en los bloques.\r\n\r\nEn particular, vamos a volver a usar nuestro conocimiento de los colores para elegir el color de nuestros bordes y sombreados.\r\n\r\n¿Preparado para sorprenderte de nuevo?', '12345678-5U4OjWgnk9y-op.png', '2018-05-16'),
(36, '12345678', 'Simpsons', 'Noticia Familiars', '12345678-5U4OjWgnk9y-op.png', '2018-04-27'),
(37, '12345678', 'Taller Recreativo', 'Nuevo capítulo, nuevo conjunto de propiedades CSS. Vamos a ver los bordes y los efectos de sombreado que se pueden aplicar, tanto en el texto como en los bloques.\r\n\r\nEn particular, vamos a volver a usar nuestro conocimiento de los colores para elegir el color de nuestros bordes y sombreados.\r\n\r\n¿Preparado para sorprenderte de nuevo?', '12345678-5U4OjWgnk9y-op.png', '2018-04-27'),
(39, '12345678', 'Nueva vistaggtgg', 'nueva', '12345678-5U4OjWgnk9y-op.png', '2018-05-16'),
(40, '70244080808', 'Taller Recreativo', 'Nuevo capítulo, nuevo conjunto de propiedades CSS. Vamos a ver los bordes y los efectos de sombreado que se pueden aplicar, tanto en el texto como en los bloques.\r\n\r\nEn particular, vamos a volver a usar nuestro conocimiento de los colores para elegir el color de nuestros bordes y sombreados.\r\n\r\n¿Preparado para sorprenderte de nuevo?', '12345678-5U4OjWgnk9y-op.png', '2018-05-16'),
(41, '12345678', 'Simpsons', 'Noticia Familiars', '12345678-5U4OjWgnk9y-op.png', '2018-04-27'),
(42, '12345678', 'Taller Recreativo', 'Nuevo capítulo, nuevo conjunto de propiedades CSS. Vamos a ver los bordes y los efectos de sombreado que se pueden aplicar, tanto en el texto como en los bloques.\r\n\r\nEn particular, vamos a volver a usar nuestro conocimiento de los colores para elegir el color de nuestros bordes y sombreados.\r\n\r\n¿Preparado para sorprenderte de nuevo?', '12345678-5U4OjWgnk9y-op.png', '2018-04-27'),
(43, '12345678', 'Nueva vista', 'nueva', '12345678-5U4OjWgnk9y-op.png', '2018-05-16');
...
(16, '207270826', 'AVISO', 'sas', '2018-04-27', 'NUEVO', 0),
(17, '207270826', 'AVISO', 'asas', '2018-04-27', 'NUEVO', 0),
(18, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'PROCESO', 1),
(19, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(20, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(21, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'RECHAZADO', 1),
(22, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(23, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(24, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'RECHAZADO', 1),
(25, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(26, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(27, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(28, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(29, '207270826', 'AVISO', 'Asunto Personal', '2018-04-27', 'NUEVO', 1),
(30, '207270826', 'AVISO', 'dsdsdsd', '2018-04-27', 'PROCESO', 1),
(31, '207270826', 'AVISO', 'dsds', '2018-04-27', 'NUEVO', 1),
(32, '207270826', 'AVISO', 'sas', '2018-04-27', 'NUEVO', 1),
(33, '207270826', 'AVISO', 'asas', '2018-04-27', 'NUEVO', 1),
(34, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'PROCESO', 1),
(35, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(36, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(37, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'RECHAZADO', 1),
(38, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(39, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(40, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'RECHAZADO', 1),
(41, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(42, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(43, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(44, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(45, '207270826', 'AVISO', 'Asunto Personal', '2018-04-27', 'NUEVO', 1),
(46, '207270826', 'AVISO', 'dsdsdsd', '2018-04-27', 'PROCESO', 1),
(47, '207270826', 'AVISO', 'dsds', '2018-04-27', 'NUEVO', 1),
(48, '207270826', 'AVISO', 'sas', '2018-04-27', 'NUEVO', 1),
(49, '207270826', 'AVISO', 'asas', '2018-04-27', 'NUEVO', 1),
(50, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'PROCESO', 1),
(51, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(52, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(53, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'RECHAZADO', 1),
(54, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(55, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(56, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'RECHAZADO', 1),
(57, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(58, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(59, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'PROCESO', 1),
(60, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(61, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(62, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'RECHAZADO', 1),
(63, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(64, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(65, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'RECHAZADO', 1),
(66, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(67, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(68, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(69, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(70, '207270826', 'AVISO', 'Asunto Personal', '2018-04-27', 'NUEVO', 1),
(71, '207270826', 'AVISO', 'dsdsdsd', '2018-04-27', 'RECHAZADO', 1),
(72, '207270826', 'AVISO', 'dsds', '2018-04-27', 'NUEVO', 1),
(73, '207270826', 'AVISO', 'sas', '2018-04-27', 'NUEVO', 1),
(74, '207270826', 'AVISO', 'asas', '2018-04-27', 'NUEVO', 1),
(75, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'RECHAZADO', 1),
(76, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(77, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(78, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'RECHAZADO', 1),
(79, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(80, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(81, '207270826', 'AVISO', 'Aviso', '2018-04-27', 'NUEVO', 1),
(82, '207270826', 'PERMISO', 'Permiso', '2018-04-27', 'NUEVO', 1),
(83, '207270826', 'QUEJA', 'Queja', '2018-04-27', 'NUEVO', 1),
(85, '207270826', 'PERMISO', 'Comida Rx', '2018-05-17', 'NUEVO', 1);
...
--
ALTER TABLE `tbarticulodanado`
  MODIFY `iddano` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tbhorario`
  MODIFY `idhorario` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `tbhorariolavanderia`
  MODIFY `idhorariolavanderia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `tbnoticias`
  MODIFY `idnoticia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
-- AUTO_INCREMENT de la tabla `tbpermisos`
--
ALTER TABLE `tbpermisos`
  MODIFY `idpermiso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
--
