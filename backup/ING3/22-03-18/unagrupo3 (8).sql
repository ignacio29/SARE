...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-03-2018 a las 22:32:10
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `reporteHorarioLavanderiaCedula` (IN `cedula` VARCHAR(50))  NO SQL
...
(3, '702430805', 'ANA', 'Cespedes', 'Quiros', 'M', 21, 2014, 'Ingenieria en Sistemas', 2, 1, 0),
(38, '1234567', 'Jonny', 'htgjhg', '  jghje', 'M', 1, 12, 'Administración de Empresas', 43, 0, 0),
...
(1, 1, 'LUNES', '08AM', '10AM', 'Ingles-Ivannia'),
(2, 1, 'MARTES', '01PM', '04PM', 'Meca-Cristel'),
(3, 1, 'MARTES', '06PM', '09PM', 'Metodos-Juan Carlos');
...
(8, '777777777777', 'ParraNoticia', 'Prueba', '777777777777-427KXHuWEOd.jpeg', '2018-03-22'),
(15, '12345678', 'Perro', 'Felizeee', '12345678-1ZKzeIwQlc2.jpeg', '2018-03-22'),
(16, '12345678', 'yy6y', '6y6y', '12345678-22jLQIPOrVY.jpeg', '2018-03-22'),
(17, '12345678', 'htth', 'thth6y', '12345678-3zS6hLBtMK4.jpeg', '2018-03-22');
