				...
				<li class="submenu dropdown" >
                   ...
                   <ul class="dropdown-menu" style="padding: 50px;min-width: 400px;" ID="menuLogin">
                         ...
                         <div class="row">
								...
								<form class="form">
									<label>CORREO</label>
									<input type="email" class="form-control"onkeyup="validarCorreoIndex(this),permitirLogeo()" onfocusout="permitirLogeo()" id="user" placeholder="Correo" required>
                         <span id="estadoCorreo"></span>
									<br>
									<label>CONTRASEÑA</label>
									<input type="password" class="form-control" onkeyup="validarPrimerCorreo(this),permitirLogeo()" onfocusout="permitirLogeo()"  id="pass" placeholder="Contraseña" required>
<span id="passValid1"></span>
								...
								<div class="form-group">
									...
									<li>
										<button id="loGin" onclick="VerificarLogin()" disabled=true  name="registarNoticia" >INGRESAR</button>
									...
									<br><span id="mensajeRecordatorio"> "El INGRESAR se hablitara hasta
									que complete los datos."</span>
								</div>
